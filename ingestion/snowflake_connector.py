...
class SnowflakeConnector:
    ...
    def write(self, df, df_name):
        try:
            write_pandas(self.conn, df, df_name, auto_create_table=True, use_logical_type=True, overwrite=True)
            print(f"{df_name} written successfully")
        except Exception as e:
            print(f"Error: {e}")
